function [result1,result2,to] = plotsigbrackets_ED(ds,gs,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ################################################################# %% DESCRIPTION
%FUNCTION  short desc.
%
...
%% Parse inputs
    ...
    addParameter(inp,'bracket_text_y_gap_coeff',3,@(x) isnumeric(x) && ~isempty(x)); % text is separated from brackets by bracket_y_gap/text_y_gap_coeff
